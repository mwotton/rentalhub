...
runQuery(worker, `select posts.post_id,posts.group_id,posts.sqm,posts.number_of_rooms,price.price from posts join price on price.post_id=posts.post_id where price.currency='USD' limit 40`);
